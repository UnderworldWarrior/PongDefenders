...
public class Player2_Goal_Script : MonoBehaviour {
    ...
    void OnTriggerEnter2D(Collider2D pongBall) {
        ...
        if (pongBall.gameObject.tag == "Ball") {
            ...
            //----------------------Check For Player 2 Victory & End Game------------------------
    ...
    void gameOver() {
        ...
        Destroy(GameObject.Find("Pong Player 1"));
        GameObject.Find("Pong Player 2").GetComponent<Player2_Movement>().enabled = false;
