...
public class Player_Goal_Script : MonoBehaviour {
    ...
    void OnTriggerEnter2D(Collider2D pongBall) {
        ...
        if (pongBall.gameObject.tag == "Ball") {
            ...
            //----------------------Check For Player Victory & End Game------------------------
    ...
    void gameOver() {
        ...
        GameObject.Find("Pong Player").GetComponent<Player1_Movement>().enabled = false;
        Destroy(GameObject.Find("Pong AI"));
